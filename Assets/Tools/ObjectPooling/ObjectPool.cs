...
public class ObjectPool<T> : IObjectPool<T> where T : MonoBehaviour, IPooledObject<T>
{
    ...
    public ObjectPool(T poolingObject, int startCount, Transform root, bool isExpandable = false, float lifeTimeObject = 0)
    {
    ...
    private void Initialize()
    {
        ...
        {
            var cloneObject = GameObject.Instantiate(_poolingObject, _root);
